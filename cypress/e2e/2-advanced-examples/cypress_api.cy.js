/* eslint-disable camelcase, id-length, init-declarations, no-console, no-param-reassign, no-undef, no-unused-expressions, no-unused-vars, sort-keys, sort-vars, prefer-destructuring */
