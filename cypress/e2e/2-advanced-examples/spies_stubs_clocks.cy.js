/* eslint-disable func-names, id-length, init-declarations, no-console, no-empty-function, no-invalid-this, no-param-reassign, no-undef, new-cap, no-unused-expressions, no-unused-vars, one-var, sort-keys, sort-vars, prefer-destructuring */
